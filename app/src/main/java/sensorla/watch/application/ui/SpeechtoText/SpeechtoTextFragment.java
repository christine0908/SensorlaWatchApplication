package sensorla.watch.application.ui.SpeechtoText;
...
public class SpeechtoTextFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_speechto_text, container, false);
        checkPermission();
        ...
        root.findViewById(R.id.button).setOnTouchListener(new View.OnTouchListener() {
            @Override
